...
async function testMainContentNarration() {
    ...
    try {
        ...
        const result = await (0, narrationGenerator_1.generateStepNarration)(testStep, testTopic, testVisuals);
...
async function testClarificationNarration() {
    ...
    try {
        ...
        const result = await (0, narrationGenerator_1.generateClarificationNarration)(testInput);
        assert(result !== undefined, 'Result should be defined');
...
async function testPerformance() {
    ...
    try {
        ...
        const result = await (0, narrationGenerator_1.generateStepNarration)(testStep, 'Test Topic', testVisuals);
...
//# sourceMappingURL=test-enhanced-narration.js.map