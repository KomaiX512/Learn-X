...
async function codegenAgent(step, params = {}, query, onChunk) {
    ...
    const needsCustomSketch = topicLower.includes('anatomy') ||
    ...
    const needsShapes = topicLower.includes('network') && !topicLower.includes('neural') ||
    ...
    const needsMath = topicLower.includes('function') ||
